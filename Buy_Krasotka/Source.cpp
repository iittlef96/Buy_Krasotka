...
//тематика - аксессуары, название - красотка
...
void Start()
{
	...
	std::cout << "\n\t\t\tДобро пожаловать в магазин Красотка" << std::endl;
...
void CreateStorage()
{
	...
	std::string name[staticSize]{ "Помада    ","Тушь      ","Тени      " ,
		"Косметичка" ,"Хайлатер  " ,"Румяна    ",
		"Пудра     ","Блеск     ","Крем      ",
		"Шампунь   " };
	int count[staticSize]{ 90,100,80,88,66,39,45,100,79, 50 };
	float price[staticSize]{ 350,500,800,599.99,699.99,499,200.50,299.99,200,250 };
